 ...
 */
public class Vowel_hk extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View  v = inflater.inflate(R.layout.fragment_vowel_hk, container, false);

        pool = new SoundPool(1, AudioManager.STREAM_MUSIC, 0);
        sound = pool.load(getActivity(), R.raw.hk, 1);
        soundWord = pool.load(getActivity(), R.raw.word_hk, 1);
